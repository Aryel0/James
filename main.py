...
class UI(QMainWindow):
    ...
    def create_menubar(self):
        ...
        main_theme_action.triggered.connect(lambda: self.apply_theme("ressources/green.qss"))
        ...
        dark_theme_action.triggered.connect(lambda: self.apply_theme("ressources/dark.qss"))
    ...
    def add_message(self, text, is_user=True):
        ...
        text_color = "#ffffff" if is_user else "#ccffcc"  
